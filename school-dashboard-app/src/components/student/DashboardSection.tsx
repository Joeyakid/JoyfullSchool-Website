    ...
    return (
        <div className={cn("mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500", className)}>
            ...
            <div className="relative mb-4">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-500 text-white py-2 px-4 rounded-r-md inline-flex items-center gap-2 shadow-sm font-semibold text-sm tracking-wide uppercase">
